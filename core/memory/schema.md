...
### sessions/YYYY-MM-DD-observations.md
...
**Entry format (full):** For Bash, WebFetch, WebSearch, Task, and other external tools:

```markdown
- **HH:MM:SS** | `Bash` | execute | `/path/to/file` | `npm test` | success
```

**Entry format (stub):** For Read, Write, Edit, Glob, Grep, MultiEdit, NotebookEdit:
